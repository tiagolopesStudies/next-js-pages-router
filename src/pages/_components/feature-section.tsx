      ...
      <div className="col-span-full flex flex-col gap-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg bg-gray-500 p-6 md:p-12">
          <div className="flex flex-col gap-4">
            ...
            <Button
              className="hidden rounded-full mt-4 md:mt-auto md:flex transition-colors"
              asChild
            >
              <Link href="/">
          ...
          <div className="flex flex-col items-center justify-center w-full">
            ...
            <Button className="w-full flex gap-2 rounded-full mt-4 md:hidden" asChild>
              <Link href="/">
                Criar loja grátis <ArrowRightIcon />
              </Link>
            </Button>
